...
def escolher_opcoes():
    ...
    mostrar_subtitulo("𝒓𝒆𝒔𝒕𝒂𝒖𝒓𝒂𝒏𝒕𝒆 𝒆𝒙𝒑𝒓𝒆𝒔𝒔𝒐\n".ljust(20))
...
def alternar_estado_restaurante():
     ...
     nome_restaurante = input("Por favor, digite o nome do Restaurante que deseja alterar.")
...
def main():
    ...
    while True:
        try:
            escolher_opcoes()
            opcaodigitada = int(input("Digite sua opção: "))
            if opcaodigitada == 1:
